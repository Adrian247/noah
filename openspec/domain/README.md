...
| Documento | Contexto |
|-----------|----------|
| [identity.md](identity.md) | Usuarios, roles, membresías |
| [companies.md](companies.md) | Tenants y sitios |
...
| [ai.md](ai.md) | Casos de uso IA |
| [audit.md](audit.md) | Auditoría |

Términos comunes: [glosario](../glossary/ubiquitous-language.md).
