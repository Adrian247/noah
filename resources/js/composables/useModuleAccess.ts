...
const ROUTE_MODULE_PAIRS: [string, string][] = [
    ...
    ['/app/services/types', 'design_routine_types'],
    ...
    ['/app/predictive', 'predictive'],
    ['/app/assets', 'predictive'],
    ['/app/sites', 'sites'],
    ['/app/billing', 'billing'],
    ['/app/integrations/webhooks', 'integrations'],
    ['/app/integrations/automation', 'integrations'],
    ['/app/integrations/mcp', 'integrations'],
